...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(ILogger<StandaloneProfileUi> logger, ShibaBridgeMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, ShibaBridgeProfileManager shibabridgeProfileManager, PairManager pairManager, Pair pair,
        PerformanceCollectorService performanceCollector)
        : base(logger, mediator, "Profile of " + pair.UserData.AliasOrUID + "##ShibaBridgeSyncStandaloneProfileUI" + pair.UserData.AliasOrUID, performanceCollector)
    {
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var shibabridgeProfile = _shibabridgeProfileManager.GetShibaBridgeProfile(Pair.UserData);
            ...
            ImGui.SameLine();
            var descriptionTextSize = ImGui.CalcTextSize(shibabridgeProfile.Description, hideTextAfterDoubleHash: false, 256f);
            ...
            if (ImGui.BeginChildFrame(1000, childFrame))
            {
                ...
                ImGui.TextWrapped(shibabridgeProfile.Description);
            }
            ImGui.EndChildFrame();
