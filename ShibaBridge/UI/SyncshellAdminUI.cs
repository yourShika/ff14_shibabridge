// SyncshellAdminUI - part of ShibaBridge project.
...
public class SyncshellAdminUI : WindowMediatorSubscriberBase
{
    ...
    public SyncshellAdminUI(ILogger<SyncshellAdminUI> logger, ShibaBridgeMediator mediator, ApiController apiController,
