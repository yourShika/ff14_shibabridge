// ShibaBridgeCharaFileData - part of ShibaBridge project.
...
public record ShibaBridgeCharaFileData
{
    ...
    public ShibaBridgeCharaFileData() { }
    public ShibaBridgeCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static ShibaBridgeCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<ShibaBridgeCharaFileData>(Encoding.UTF8.GetString(data))!;
    }
