...
namespace ShibaBridge.PlayerData.Services;
...
public sealed class CacheCreationService : DisposableMediatorSubscriberBase
{
    ...
    public CacheCreationService(ILogger<CacheCreationService> logger, ShibaBridgeMediator mediator, GameObjectHandlerFactory gameObjectHandlerFactory,
