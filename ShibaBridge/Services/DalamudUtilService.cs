...
public class DalamudUtilService : IHostedService, IMediatorSubscriber
{
    ...
    public DalamudUtilService(ILogger<DalamudUtilService> logger, IClientState clientState, IObjectTable objectTable, IFramework framework,
        ...
        BlockedCharacterHandler blockedCharacterHandler, ShibaBridgeMediator mediator, PerformanceCollectorService performanceCollector)
    {
        _logger = logger;
...
#pragma warning disable S2696 // Instance members should not write to "static" fields
        ShibaBridge.Plugin.Self.RealOnFrameworkUpdate = this.FrameworkOnUpdate;
#pragma warning restore S2696
        _framework.Update += ShibaBridge.Plugin.Self.OnFrameworkUpdate;
        if (IsLoggedIn)
        {
