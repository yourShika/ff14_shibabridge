// CharaDataHubUi - part of ShibaBridge project.
...
internal sealed partial class CharaDataHubUi : WindowMediatorSubscriberBase
{
    ...
    public CharaDataHubUi(ILogger<CharaDataHubUi> logger, ShibaBridgeMediator mediator, PerformanceCollectorService performanceCollectorService,
        ...
        : base(logger, mediator, "ShibaBridge Character Data Hub###ShibaBridgeCharaDataUI", performanceCollectorService)
    {
        ...
        Mediator.Subscribe<GposeStartMessage>(this, (_) => IsOpen |= _configService.Current.OpenShibaBridgeHubOnGposeStart);
        ...
        if (_readExport)
        {
            ...
            if (_uiSharedService.IconTextButton(FontAwesomeIcon.Save, "Export Character as MCDF"))
            {
                ...
                _uiSharedService.FileDialogManager.SaveFileDialog("Export Character to file", ".mcdf", defaultFileName, ".mcdf", (success, path) =>
                {
                    ...
                    _charaDataManager.SaveShibaBridgeCharaFile(_exportDescription, path);
    ...
    private void DrawSettings()
    {
        ...
        ImGuiHelpers.ScaledDummy(5);
        bool openInGpose = _configService.Current.OpenShibaBridgeHubOnGposeStart;
        if (ImGui.Checkbox("Open Character Data Hub when GPose loads", ref openInGpose))
        {
            _configService.Current.OpenShibaBridgeHubOnGposeStart = openInGpose;
            _configService.Save();
        }
