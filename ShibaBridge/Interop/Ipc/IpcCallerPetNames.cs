// IpcCallerPetNames - part of ShibaBridge project.
...
public sealed class IpcCallerPetNames : IIpcCaller
{
    ...
    {
        CheckAPI();
        _shibabridgeMediator.Publish(new PetNamesReadyMessage());
    }

    private void OnPetNicknamesDispose()
    {
        _shibabridgeMediator.Publish(new PetNamesMessage(string.Empty));
    }
    ...
    {
        _shibabridgeMediator.Publish(new PetNamesMessage(data));
    }
