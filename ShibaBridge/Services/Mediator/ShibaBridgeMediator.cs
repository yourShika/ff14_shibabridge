...
public sealed class ShibaBridgeMediator : IHostedService
{
    ...
    public ShibaBridgeMediator(ILogger<ShibaBridgeMediator> logger, PerformanceCollectorService performanceCollector, ShibaBridgeConfigService shibabridgeConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting ShibaBridgeMediator");
        ...
        _logger.LogInformation("Started ShibaBridgeMediator");
