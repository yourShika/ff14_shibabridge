...
using CharacterData = ShibaBridge.PlayerData.Data.CharacterData;
...
public class PlayerDataFactory
{
    ...
    public PlayerDataFactory(ILogger<PlayerDataFactory> logger, DalamudUtilService dalamudUtil, IpcManager ipcManager,
        ...
        PerformanceCollectorService performanceCollector, XivDataAnalyzer modelAnalyzer, ShibaBridgeMediator shibabridgeMediator)
    {
        _logger = logger;
    ...
    private async Task VerifyPlayerAnimationBones(Dictionary<string, List<ushort>>? boneIndices, CharacterData previousData, ObjectKind objectKind)
    {
        ...
        {
            _shibabridgeMediator.Publish(new NotificationMessage("Invalid Skeleton Setup",
