...
public class DownloadUi : WindowMediatorSubscriberBase
{
    ...
    public DownloadUi(ILogger<DownloadUi> logger, DalamudUtilService dalamudUtilService, ShibaBridgeConfigService configService,
        FileUploadManager fileTransferManager, ShibaBridgeMediator mediator, UiSharedService uiShared, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "ShibaBridge Downloads", performanceCollectorService)
    {
