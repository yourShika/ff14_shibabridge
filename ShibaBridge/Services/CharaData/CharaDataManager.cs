...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataManager(ILogger<CharaDataManager> logger, ApiController apiController,
        ...
        ShibaBridgeMediator shibabridgeMediator, IpcManager ipcManager, DalamudUtilService dalamudUtilService,
        ...
        CharaDataCharacterHandler charaDataCharacterHandler, PairManager pairManager) : base(logger, shibabridgeMediator)
    {
        ...
        shibabridgeMediator.Subscribe<ConnectedMessage>(this, (msg) =>
        {
            _connectCts?.Cancel();
            _connectCts?.Dispose();
            _connectCts = new();
        ...
        shibabridgeMediator.Subscribe<DisconnectedMessage>(this, (msg) =>
        {
            _ownCharaData.Clear();
            _metaInfoCache.Clear();
            _sharedWithYouData.Clear();
    ...
    public Task<(ShibaBridgeCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
    ...
    public void SaveShibaBridgeCharaFile(string description, string filePath)
    {
