...
public class EventAggregator : MediatorSubscriberBase, IHostedService
{
    ...
    public EventAggregator(ShibaBridgeConfigService configService, ILogger<EventAggregator> logger, ShibaBridgeMediator shibabridgeMediator) : base(logger, shibabridgeMediator)
    {
