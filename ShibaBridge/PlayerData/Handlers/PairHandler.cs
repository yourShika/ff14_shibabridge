...
using ObjectKind = ShibaBridge.API.Data.Enum.ObjectKind;

namespace ShibaBridge.PlayerData.Handlers;
...
public sealed class PairHandler : DisposableMediatorSubscriberBase
{
    ...
    public PairHandler(ILogger<PairHandler> logger, Pair pair, PairAnalyzer pairAnalyzer,
        ...
        FileCacheManager fileDbManager, ShibaBridgeMediator mediator,
        PlayerPerformanceService playerPerformanceService,
        ServerConfigurationManager serverConfigManager,
        ShibaBridgeConfigService configService, VisibilityService visibilityService,
    ...
    private void UpdateVisibility(bool nowVisible, bool invalidate = false)
    {
        ...
        // This was triggered by the character becoming handled by ShibaBridge, so unapply everything
        // There seems to be a good chance that this races ShibaBridge and then crashes
